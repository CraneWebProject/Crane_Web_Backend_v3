...
public class InstrumentController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<InstrumentResponseDto>> createInstrument(@RequestBody InstrumentRequestDto instrumentDto) {
    ...
    @PutMapping
    public ResponseEntity<ApiResponse<InstrumentResponseDto>> updateInstrument(@RequestBody InstrumentRequestDto instrumentDto) {
    ...
    @DeleteMapping
    public ResponseEntity<ApiResponse<?>> deleteInstrument(@RequestBody InstrumentRequestDto instrumentDto) {
